...
## <a id="level-1"></a>Level 1: blooky-fp のみ - リアクティブな値の管理
...
const $text = hold("")(map((e)=>e.target.value)(input$));
...
interface CounterContext {
  $count: Prop<number>;
  increment$: Dripper<void>;
  decrement$: Dripper<void>;
}
...
## <a id="level-3"></a>Level 3: + blooky-fx - 副作用の管理
...
## <a id="level-4"></a>Level 4: + blooky-fxdom - 宣言的な副作用
...
## <a id="level-5"></a>Level 5: + blooky-devtools - デバッグと可視化
